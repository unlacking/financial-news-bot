...
def run_pipeline(execution_mode: str = "INTRADAY"):
    ...
    # Initialize containers for collected data to feed into the digest and alerting system
    scraped_news = []
    gemini_analyses = []
    collected_prices = []
    ...
    try:
        ...
        if scraped_news:
            ...
            # Filter out articles that have already been logged in today's local archive
            ...
            # Update the local file cache with all scraped news items safely
